...
class TestPasiChat(unittest.TestCase):
    ...
    def test_browser_state_uses_state_endpoint_shape(self) -> None:
    ...
    def test_real_chatgpt_adapter_accepts_health_for_liveness(self) -> None:
        class Transport:
            def request(self, method, path, payload=None):
                ...
                if method == "GET" and path == "/browser/state":
                    return {"observation": {"data": {
                        "kind": "chatgpt_state",
                        "chat_url": "https://chatgpt.com/c/real-adapter",
                    }}}
        ...
        from scripts.pasi_chat import browser_state
        self.assertEqual(
            browser_state(adapter)["chat_url"],
            "https://chatgpt.com/c/real-adapter",
        )

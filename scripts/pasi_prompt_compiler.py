...
- A completion response that reports no repository change is valid only when verified evidence proves the task was already satisfied; the empty patch must not be used to manufacture progress. Do not invent work or cosmetic changes.

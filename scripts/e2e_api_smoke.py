...
assert isinstance(source, dict) and isinstance(source.get("source_id"), int)
...
evidence = request("POST", f"/api/engineering/projects/{project_id}/requirements/{req_id}/evidence", {"result": "100 psi", "supports_status": "Verified", "source_id": source["source_id"], "description": "CI evidence"})

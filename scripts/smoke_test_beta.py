...
def main() -> None:
    with tempfile.TemporaryDirectory() as temp:
        ...
        try:
            ...
            status, evidence = request(engineering, "POST", f"/api/engineering/projects/{project_id}/requirements/{requirement_id}/evidence", {"result": "Confirmed", "supports_status": "Verified", "source": "Smoke source", "source_id": source["id"], "description": "Smoke evidence"})

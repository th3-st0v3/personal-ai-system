    ...
    for path in py_files:
        ...
        for match in PYTHON_STRING_URL_RE.finditer(source):
            ...
            try:
                ...
                # Template URLs such as http://127.0.0.1:{port}/... do not
                # expose a concrete port to validate statically. They are
                # intentionally ignored rather than making capability
                # validation crash.
                continue

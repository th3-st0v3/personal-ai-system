...
def test_browser_json_and_python_loader_share_the_same_fast_normal_path_policy() -> None:
    raw = json.loads(
    ...
    assert raw["heartbeat_seconds"] == 5
    assert raw["stale_seconds"] == 15
    ...
    assert policy["heartbeat_seconds"] == 5

(() => {
  ...
  // Support scripts can be re-injected into an already-open ChatGPT tab by the
  // native background watchdog. Keep this module idempotent so a second
  // evaluation cannot redeclare top-level bindings in the same isolated world.
  if (globalThis.PASI_RECOVERY_PROGRESS) {
    if (typeof module !== 'undefined' && module.exports) {
      module.exports = globalThis.PASI_RECOVERY_PROGRESS;
    }
    return;
  }
